...
INSERT INTO Schedules (weekday_start, weekday_end, saturday_start, saturday_end, sunday_start, sunday_end, public_holiday_start, public_holiday_end) VALUES
...
INSERT INTO Clinics (name, block, road, unit, postal_code, phone, email, schedule_id) VALUES
...
INSERT INTO Doctors (name, clinic_id) VALUES
('Dr. David Johnson', 1),
('Dr. Emily Lee', 2),
('Dr. Michael Brown', 1),
('Dr. Sarah Smith', 2);
...
INSERT INTO AppointmentTypes (name) VALUES
('Follow-up'),
('Consultation'),
('Procedure');

-- Inserting sample data into the DoctorSpecialty table
INSERT INTO Doctors_Specialties (doctor_id, specialty_id) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 1);
...
INSERT INTO Appointments (datetime, patient_id, doctor_id, appt_type_id) VALUES
